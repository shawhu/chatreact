...
export default function ConversationllmwsMultiChars({
  prompt,
  voiceover,
  initialmessages,
  initialainame,
  ...
  const [aiAutorun, setAiAutorun] = React.useState(false);
    ...
    const handlePrompt = async (prompt: string) => {
      ...
      await handleSSE(response, (message) => {
        if (message === "[DONE]") {
          ...
          //testing to see if we need to start aiAutorun
          console.log("testing to see if we need to start aiAutorun");
